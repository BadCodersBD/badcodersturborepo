  ...
  return (
    ...
    <FormWrapper>
      ...
      >
        ...
        <button type="submit" className="registerButton bg-emerald-600" disabled={submitting}>
      ...
      <div className="px-2 text-sm text-black">
        <div className="flex justify-between">
          <div className="flex h-5 items-center pr-2">
            <input id="checked" type="checkbox" className="registerCheckbox" />
            <span className="p-2 text-white">Remember me</span>
          </div>
          <button
            className="text-green-500 bg-black cursor-pointer hover:text-green-700 hover:underline"
            onClick={(e) => {
              {
                e.preventDefault();
